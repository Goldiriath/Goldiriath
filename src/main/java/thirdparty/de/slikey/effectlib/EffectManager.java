...
public class EffectManager implements Disposable {
     ...
     *
     * @param effectClass The name of the Effect class to instantiate. If unqualified, defaults to the thirdparty.de.slikey.effectlib.effect namespace.
     ...
     * @param target The target Location, only used in some effect (like LineEffect)
     * @param originEntity The origin Entity, the effect will attach to the Entity's Location
     * @param targetEntity The target Entity, only used in some effect
    ...
    public Effect start(String effectClass, ConfigurationSection parameters, DynamicLocation origin, DynamicLocation target, Map<String, String> parameterMap, Player targetPlayer) {
        ...
        try {
            ...
            if (!effectClass.contains(".")) {
                effectClass = "thirdparty.de.slikey.effectlib.effect." + effectClass;
