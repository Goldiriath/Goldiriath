...
import thirdparty.de.slikey.effectlib.math.EquationStore;
import thirdparty.de.slikey.effectlib.math.EquationTransform;
...
public class EquationEffect extends Effect {
     ...
     *
     * These equations can make use of most common math functions, including randomized numbers. Some examples:
     *
