...
public abstract class Effect implements Runnable {
    ...
    /**
     * effect should override this if they want to be reusable, this is called prior to starting so
     * state can be reset.
     */
     ...
     *
     * This method will not return null when called from onRun. effect
