...
public class WaveEffect extends Effect {
    ...
    private ParticleEffect particle = ParticleEffect.DRIP_WATER;
    private ParticleEffect cloudParticle = ParticleEffect.CLOUD;
     ...
     */
    private final Collection<Vector> waterCache, cloudCache;
    /**
     * Amount of particles forming the tube
     */
    private int particlesFront = 10;
    /**
     * Amount of particles forming the back
     */
    private int particlesBack = 10;
    /**
    ...
    private double multiplyVelocity;
    /**
    ...
    public void onRun() {
        ...
        if (firstStep) {
            velocity.copy(location.getDirection().setY(0).normalize().multiply(multiplyVelocity));
            invalidate(location);
        }
