...
public class RayEffect extends Effect {
    @Setter @Getter
    private double RANGE = 15; // In m
    @Setter @Getter
    private double SPEED = 30; // In m/s
    @Setter @Getter
    private double DENSITY = 15; // In particles/m
    @Setter @Getter
    ...
    public RayEffect(EffectManager effectManager, LocationCallback callback, ParticleEffect particleEffect) {
        super(effectManager);
        this.callback = callback;
